...
class LaraBaseServiceProvider extends ServiceProvider
{
    public function register(): void
    {
		...
		$this->app->singleton('larapush', function () {
			return new \Sitakgmbh\LaraBase\Push\PushManager();
		});
    ...
    public function boot(): void
    {
        ...
        $this->app->register(\Sitakgmbh\LaraBase\Pwa\PwaServiceProvider::class);
		...
		$loader->alias('LaraNotify', \Sitakgmbh\LaraBase\Facades\LaraNotify::class);
        ...
        $this->commands([
			...
			\Sitakgmbh\LaraBase\Console\Test\TestPushNotification::class,
        ]);
		...
		Livewire::component('components.modals.push-settings',   \Sitakgmbh\LaraBase\Livewire\Components\Modals\PushSettingsModal::class);
